  ...
  return (
    <Navbar
      ...
      className={`rounded-xl transition-all ${
        fixedNavbar ? 'shadow-blue-gray-500/5 sticky top-4 z-40 py-3 shadow-md' : 'px-0 py-1'
      }`}
      fullWidth
      blurred={fixedNavbar}
    >
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex items-center">
          ...
          >
            <Cog6ToothIcon className="text-blue-gray-500 h-5 w-5" />
          </IconButton>
          <Menu>
            <MenuHandler>
              <IconButton variant="text" color="blue-gray">
                <BellIcon className="text-blue-gray-500 h-5 w-5" />
              </IconButton>
            </MenuHandler>
